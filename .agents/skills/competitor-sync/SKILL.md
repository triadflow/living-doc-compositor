...
description: "Sync a competitor-watcher living doc for the current monitoring period by proposing a `living-doc-ai-patch/v1` with posture updates, strategic moves, indicator changes, prediction resolutions, and a draft period note."
---

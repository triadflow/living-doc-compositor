---
name: "ai-labor-sync"
description: "Sync the AI-labor monitoring living doc for the current period by proposing a `living-doc-ai-patch/v1` with stance updates, new citations, indicator changes, prediction resolutions, and a draft period note."
---

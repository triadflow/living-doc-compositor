...
`, 'utf8');
  ...
  assert.equal(blocked.iterations[0].nextAction.action, 'continue-with-continuation-inference');
  assert.equal(blocked.iterations[0].nextAction.selectedUnitType, 'continuation-inference');

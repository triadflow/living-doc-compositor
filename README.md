...
Full templates (more depth): `architect-manuscript`, `map-themes-storylines`, `operations-support`, `proof-canonicality`, `surface-delivery`, `monitoring-tracker`, `competitor-watcher`. All in `docs/`.
